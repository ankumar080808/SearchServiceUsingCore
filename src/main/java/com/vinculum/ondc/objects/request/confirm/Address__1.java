...
public class Address__1 implements Serializable
{
    ...
    private final static long serialVersionUID = 4745182165136555141L;
     ...
     * @param building
     */
    public Address__1(String name, String building, String door, String locality, String city, String state, String country, String areaCode) {
        super();
        this.name = name;
