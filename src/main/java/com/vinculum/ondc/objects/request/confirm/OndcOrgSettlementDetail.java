...
public class OndcOrgSettlementDetail implements Serializable
{
    ...
    private final static long serialVersionUID = 5719857241974645989L;
     ...
     * @param bankName
     */
    public OndcOrgSettlementDetail(String settlementCounterparty, String settlementPhase, String settlementType, String upiAddress, String settlementBankAccountNo, String settlementIfscCode, String beneficiaryName, String bankName, String branchName) {
        super();
