...
public class Address implements Serializable
{
    ...
    private final static long serialVersionUID = 8565822192199361164L;
     ...
     * @param building
     */
    public Address(String name, String building, String door, String locality, String city, String state, String country, String areaCode) {
        super();
        this.name = name;
