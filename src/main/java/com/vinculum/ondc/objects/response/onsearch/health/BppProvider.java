...
public class BppProvider implements Serializable
{
    ...
    private final static long serialVersionUID = 7783943403440791696L;
     ...
     * @param tags
     */
    public BppProvider(String id, Time time, List<Fulfillment> fulfillments, Descriptor descriptor, String ttl, List<Location> locations, List<Item> items, List<Tag__1> tags) {
        super();
        this.id = id;
        this.time = time;
