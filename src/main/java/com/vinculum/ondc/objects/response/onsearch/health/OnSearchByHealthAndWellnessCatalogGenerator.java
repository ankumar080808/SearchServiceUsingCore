...
import com.vinculum.ondc.objects.response.onsearch.health.*;



public class OnSearchByHealthAndWellnessCatalogGenerator{

	
	
	final MetaData metadata;
	 
	public OnSearchByHealthAndWellnessCatalogGenerator(MetaData metadata)
	{
	...
	public static String generatePayload() {
		...
		reqspc.setMfgLicenseNo("51/UA/SC/P-2013");
		reqspc.setCommonOrGenericNameOfCommodity("Shelcal HD");
		reqspc.setMultipleProductsNameNumberOrQty("15");
		reqspc.setMonthYearOfManufacturePackingImport("Mar-22");
		reqspc.setExpiryDate("Feb-24");
		...
		rpf.setIngredientsInfo("Every film-coated tablet contains: 1250 mg Calcium Carbonate");
		item.setOndcOrgStatutoryReqsPrepackagedFood(rpf);
		List<Tag> tagss=new ArrayList<>();
		Tag tags=new Tag();
		tags.setCode("origin");
		List<com.vinculum.ondc.objects.response.onsearch.health.List> lists_6_1_1 = new ArrayList<>();
		com.vinculum.ondc.objects.response.onsearch.health.List list_6_1_2 = new com.vinculum.ondc.objects.response.onsearch.health.List();
		...
		List<com.vinculum.ondc.objects.response.onsearch.health.List__1> lists_10b = new ArrayList<>();
		com.vinculum.ondc.objects.response.onsearch.health.List__1 list_10b1 = new com.vinculum.ondc.objects.response.onsearch.health.List__1();
		com.vinculum.ondc.objects.response.onsearch.health.List__1 list_10b2 = new com.vinculum.ondc.objects.response.onsearch.health.List__1();
		com.vinculum.ondc.objects.response.onsearch.health.List__1 list_10b3 = new com.vinculum.ondc.objects.response.onsearch.health.List__1();
		com.vinculum.ondc.objects.response.onsearch.health.List__1 list_10b4 = new com.vinculum.ondc.objects.response.onsearch.health.List__1();
		com.vinculum.ondc.objects.response.onsearch.health.List__1 list_10b5 = new com.vinculum.ondc.objects.response.onsearch.health.List__1();
		...
		OnSearchByHealthAndWellnessCatalog search=new OnSearchByHealthAndWellnessCatalog();
