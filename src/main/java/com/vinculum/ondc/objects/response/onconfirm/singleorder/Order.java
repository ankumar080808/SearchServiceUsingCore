...
public class Order implements Serializable
{
    ...
    private final static long serialVersionUID = 6193153326579823748L;
     ...
     * @param updatedAt
     */
    public Order(String id, String state, Provider provider, List<Item> items, Billing billing, List<Fulfillment> fulfillments, Quote quote, Payment payment, List<Tag> tags, String createdAt, String updatedAt) {
        super();
        this.id = id;
        this.state = state;
