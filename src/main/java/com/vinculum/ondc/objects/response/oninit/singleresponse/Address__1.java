...
public class Address__1 implements Serializable
{
    ...
    private final static long serialVersionUID = -9221936449003784955L;
     ...
     * @param building
     */
    public Address__1(String name, String building, String locality, String city, String state, String country, String areaCode) {
        super();
        this.name = name;
