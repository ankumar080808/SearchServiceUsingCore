...
public class OndcOrgSettlementDetail implements Serializable
{
    ...
    private final static long serialVersionUID = -7133148316794886115L;
     ...
     * @param bankName
     */
    public OndcOrgSettlementDetail(String settlementCounterparty, String settlementPhase, String settlementType, String beneficiaryName, String upiAddress, String settlementBankAccountNo, String settlementIfscCode, String bankName, String branchName) {
        super();
