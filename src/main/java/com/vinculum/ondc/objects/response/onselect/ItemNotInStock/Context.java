...
public class Context implements Serializable
{
    ...
    private final static long serialVersionUID = -1013482196102061161L;
     ...
     * @param timestamp
     */
    public Context(String domain, String action, String coreVersion, String bapId, String bapUri, String bppId, String bppUri, String transactionId, String messageId, String city, String country, String timestamp) {
        super();
        this.domain = domain;
        this.action = action;
