...
public class Order implements Serializable
{
    ...
    private final static long serialVersionUID = -7513989141649288615L;
     ...
     * @param billing
     */
    public Order(Provider provider, ProviderLocation providerLocation, List<Item> items, Billing billing, List<Fulfillment> fulfillments, Quote quote, Payment payment) {
        super();
