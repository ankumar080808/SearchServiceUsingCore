...
public class Item implements Serializable
{
    ...
    private final static long serialVersionUID = -9045292795180207040L;
     ...
     * @param categoryId
     */
    public Item(String id, Time__2 time, String parentItemId, Descriptor__2 descriptor, Quantity quantity, Price price, String categoryId, String fulfillmentId, String locationId, boolean ondcOrgReturnable, boolean ondcOrgCancellable, String ondcOrgReturnWindow, boolean ondcOrgSellerPickupReturn, String ondcOrgTimeToShip, boolean ondcOrgAvailableOnCod, String ondcOrgContactDetailsConsumerCare, OndcOrgStatutoryReqsPackagedCommodities ondcOrgStatutoryReqsPackagedCommodities, OndcOrgStatutoryReqsPrepackagedFood ondcOrgStatutoryReqsPrepackagedFood, List<Tag__1> tags) {
        super();
        this.id = id;
        this.time = time;
